    ...
    <>
      ...
      >
        <div className="relative aspect-[3/4] w-full overflow-hidden rounded-lg border-2 shadow-lg">
          ...
          <img
            src={manga.imageUrl || "https://placeholder.pics/svg/300x400/CCCCCC/FFFFFF/No%20Cover"}
            alt={manga.name}
            className="h-full w-full object-cover"
            loading="eager"
            onError={(e) => {
              const target = e.target as HTMLImageElement;
              target.src = "https://placeholder.pics/svg/300x400/CCCCCC/FFFFFF/No%20Cover";
            }}
          />
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <Badge variant={manga.contentRating === "safe" ? "secondary" : "destructive"}>
                {manga.contentRating}
              </Badge>
            </div>
            <div className="flex items-center gap-2 text-sm">
