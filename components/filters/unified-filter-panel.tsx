...
import { TriggerFilterContent } from "./trigger-filter-content";
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-[90vh] max-w-5xl flex flex-col p-0 gap-0">
        <DialogHeader className="px-6 pt-6 pb-4 border-b">
          <DialogTitle className="text-2xl">Filter Manga</DialogTitle>
          <DialogDescription>
            Refine your search with custom filters
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-4">
          ...
          <Card className="border-2 shadow-sm hover:shadow-md transition-shadow">
            <CardHeader className="pb-3">
              <CardTitle className="text-base font-semibold">Triggers & Themes</CardTitle>
            </CardHeader>
            <CardContent>
              <TriggerFilterContent enabled={open} />
            </CardContent>
          </Card>
